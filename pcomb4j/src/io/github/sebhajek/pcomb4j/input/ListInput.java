 ...
 *
 * <p>Elements are addressed by an integer cursor that starts at 0 and
 * advances by 1 with each call to {@link #advance()}. The underlying list
 * is never mutated; backtracking is achieved by retaining a reference to
 * an earlier {@code ListInput} instance.
 *
...
public class ListInput<A> implements ParserInput<A> {
	...
	/**
	 * Creates a {@code ListInput} positioned at the first element of
	 * {@code input}.
	 *
