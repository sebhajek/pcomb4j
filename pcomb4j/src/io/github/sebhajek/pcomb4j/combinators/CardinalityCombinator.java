...
/**
 * Combinator that applies a parser a variable number of times, collecting
 * all results into a {@link java.util.List}.
 *
...
public interface CardinalityCombinator<Output, Input>
	 ...
	 * collecting each result into an unmodifiable {@link java.util.List}.
	 *
	 * <p>The first application is mandatory; if it fails a
	 * {@link ParserError} is propagated.
	 * Subsequent applications stop as soon as the underlying parser fails.
	 *
