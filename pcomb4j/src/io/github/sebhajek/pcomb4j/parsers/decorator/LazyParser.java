 ...
 * grammars. Because a {@link Supplier} can close over a variable that has not
 * yet been initialised at the time {@code LazyParser} is constructed, the
 * actual inner parser can be defined after the {@code LazyParser} is created.
 *
