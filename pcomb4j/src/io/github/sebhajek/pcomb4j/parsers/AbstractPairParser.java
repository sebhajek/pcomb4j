 ...
 *
 * <p>This class is the common foundation for {@code AndParser} and {@code
 * OrParser}, both of which operate on two independently typed child parsers.
 *
 * @param <Output> the type of value produced by this parser after combining
 *   both sub-results
