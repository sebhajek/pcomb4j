...
/**
 * A {@link Parser} that succeeds when the current input element equals a fixed
 * expected value.
 *
...
public class LiteralParser<Input> extends AbstractParser<Input, Input> {
	...
	/**
	 * Creates a {@code LiteralParser} that uses a custom {@link Comparator} for
	 * equality testing.
	 *
	 ...
	 *   advanced input
	 * @throws ParserError if the input is empty or the current element does not
	 *   match the expected
	 *     literal
	 */
	@Override
