...
/**
 * Abstract base class for {@link CombinatorParser} implementations that
 * act as their own parse source (i.e. they <em>are</em> the parser rather than
 * wrapping one).
 *
...
public abstract class AbstractParser<Output, Input>
	 ...
	 *
	 * @param logger the logger used for debug output during parsing;
	 *               never {@code null}
	 */
