 ...
 *
 * <p>A {@code ParserResult} pairs the value produced by the parse ({@link
 * #result()}) with the
 * {@link ParserInput} representing whatever input remains to be consumed
 * ({@link #remainder()}). This remainder is typically fed into subsequent
 * parsers when combinators sequence multiple parses together.
 *
